...
public class FeedbackController {
                ...
                if (authentication == null || !authentication.isAuthenticated()) {
                        return ResponseEntity.status(HttpStatus.UNAUTHORIZED)
                                        .body(Map.of(
                                                        "success", false,
                                                        "message",
                                                        "Unauthorized - Authentication required to submit feedback"));
                }
        ...
        public ResponseEntity<Map<String, Object>> getProductReviews(@PathVariable Long productId) {
                try {
                        List<FeedbackResponse> reviews = feedbackService.getApprovedFeedbacksForTarget(productId,
                                        "PRODUCT");
        ...
        public ResponseEntity<Map<String, Object>> getServiceReviews(@PathVariable Long serviceId) {
                try {
                        List<FeedbackResponse> reviews = feedbackService.getApprovedFeedbacksForTarget(serviceId,
                                        "SERVICE");
                        ...
                        if (user.getRole() != Role.ADMIN) {
                                return ResponseEntity.status(HttpStatus.FORBIDDEN)
                                                .body(Map.of(
                                                                "success", false,
                                                                "message",
                                                                "Forbidden - Only admins can access feedbacks"));
                        }
                        ...
                        if (user.getRole() != Role.ADMIN) {
                                return ResponseEntity.status(HttpStatus.FORBIDDEN)
                                                .body(Map.of(
                                                                "success", false,
                                                                "message",
                                                                "Forbidden - Only admins can access feedback"));
                        }
        ...
        public ResponseEntity<Map<String, Object>> getFeedbacksForTarget(
                ...
                try {
                        ...
                        List<FeedbackResponse> feedbacks = feedbackService.getFeedbacksForTarget(targetId,
                                        feedbackType);
                        ...
                        if (user.getRole() != Role.ADMIN) {
                                return ResponseEntity.status(HttpStatus.FORBIDDEN)
                                                .body(Map.of(
                                                                "success", false,
                                                                "message",
                                                                "Forbidden - Only admins can delete feedbacks"));
                        }
                        ...
                        if (user.getRole() != Role.ADMIN) {
                                return ResponseEntity.status(HttpStatus.FORBIDDEN)
                                                .body(Map.of(
                                                                "success", false,
                                                                "message",
                                                                "Forbidden - Only admins can access statistics"));
                        }
                ...
                try {
                        ...
                        if (user.getRole() != Role.ADMIN) {
                                return ResponseEntity.status(HttpStatus.FORBIDDEN)
                                                .body(Map.of(
                                                                "success", false,
                                                                "message",
                                                                "Forbidden - Only admins can access feedback count"));
                        }
                        ...
                        return ResponseEntity.status(HttpStatus.INTERNAL_SERVER_ERROR)
                                        .body(Map.of(
                                                        "success", false,
                                                        "message",
                                                        "Error retrieving feedback count: " + e.getMessage()));
                }
        }
                        ...
                        if (user.getRole() != Role.ADMIN) {
                                return ResponseEntity.status(HttpStatus.FORBIDDEN)
                                                .body(Map.of(
                                                                "success", false,
                                                                "message",
                                                                "Forbidden - Only admins can approve feedback"));
                        }
